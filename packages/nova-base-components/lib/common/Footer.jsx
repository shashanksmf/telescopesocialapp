...
const collectionIconCSS = { "background-image":"/packages/my-custom-package/public/collection-image.png" };
    ...
    <div className="footer">
      {isPhone ? <div className="footer-links clearfix">
        ...
        <div className="footer-item">
          <Link  to="/categoriesMenu">
            <div className="collection-icon" style={collectionIconCSS} classNamesds="fa fa-cubes"/>
