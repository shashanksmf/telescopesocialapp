...
class CustomPostsPageItem extends Telescope.components.PostsItem {
...
CustomPostsPageItem.propTypes = {
  post: React.PropTypes.object.isRequired
}

CustomPostsPageItem.contextTypes = {
  currentUser: React.PropTypes.object
};

export default CustomPostsPageItem;
